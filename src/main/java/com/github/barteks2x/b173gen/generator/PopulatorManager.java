...
public class PopulatorManager {
    ...
    public PopulatorManager(World world, WorldChunkManagerOld wcm, WorldConfig config) {
        ...
        add("WaterLakes", new RareResource(
                new WorldGenLakesOld(LEGACY_STATIONARY_WATER),
                HeightDistrubution.DEFAULT,
                4)
        );
        add("LavaLakes", new RareUndergroundResource(
                new WorldGenLakesOld(LEGACY_STATIONARY_LAVA),
                new DepthPackedHeightDistribution(0, 8, 126),
                8, 64, 10)
        );
        ...
        add("RandomWater", new CommonResource(new WorldGenLiquidsOld(LEGACY_STATIONARY_WATER), new DepthPackedHeightDistribution(0, 8, 126), 50));
        add("RandomLava", new CommonResource(new WorldGenLiquidsOld(LEGACY_STATIONARY_LAVA), (rand) -> rand.nextInt(rand.nextInt(rand.nextInt(112) + 8) + 8), 20));
